...
class Curl {
	...
	const USER_AGENT = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:30.0) Gecko/20100101 Firefox/30.0';
 ...
 //  curl_setopt($ch, CURLOPT_TIMEOUT, 400) 
	...
	public function post($url, $data=array()) {
		...
		$this->request = $this->_postfields($data);
		return $this->exec();
	}
